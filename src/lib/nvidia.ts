...
- Group closely related subtopics together into broader topic nodes so that the total number of nodes does not exceed 30. This is critical to ensure fast, reliable generation without truncation.
